 ...
 * Browser / ZIP pipeline: parse JSON from extracted `gitnexus.filter` entry via `parseProcessFilterFromJson`.
...
const win = (): boolean => typeof process !== 'undefined' && process.platform === 'win32';
